...
import { ServicesHeroSettings } from '../../../types';

interface ServicesStylingTabProps {
...
export function ServicesStylingTab({ settings, isRTL, onSettingsChange }: ServicesStylingTabProps) {
    return (
