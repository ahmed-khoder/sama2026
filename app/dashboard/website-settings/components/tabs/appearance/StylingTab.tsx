...
function ColorPickerField({
    ...
    return (
        <div className="p-3 sm:p-4 bg-gray-50 dark:bg-slate-900 rounded-xl space-y-2 sm:space-y-3">
            ...
            {/* Color Preview + Picker Row - Responsive */}
            <div className="flex items-center gap-3 sm:gap-4">
                {/* Native Color Picker - Responsive Size */}
...
export function StylingTab({ settings, isRTL, onSettingsChange }: StylingTabProps) {
    return (
