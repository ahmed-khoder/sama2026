...
interface AboutStylingTabProps {
...
export function AboutStylingTab({ settings, isRTL, onSettingsChange }: AboutStylingTabProps) {
    return (
        <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 sm:space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    />
                    <ColorPickerField
                        label={isRTL ? 'لون السطر الثالث' : 'Line 3 Color'}
                        value={settings.titleLine3Color}
                        onChange={(color) => onSettingsChange('titleLine3Color', color)}
                        isRTL={isRTL}
                    />
                    <ColorPickerField
