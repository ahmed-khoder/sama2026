...
import { Plus, Trash2, ChevronUp, ChevronDown, RefreshCw, Monitor, Smartphone, Upload, Image as ImageIcon, Settings, Layers } from 'lucide-react';
...
interface HeroTabProps {
    ...
    onUpdateSlideImage: (id: string, field: 'imageDesktopAr' | 'imageDesktopEn' | 'imageMobile', path: string) => Promise<void>;
...
type SubSection = 'slides' | 'settings';
        ...
        <div className="space-y-4">
            ...
            <div className="flex gap-2 p-1 bg-gray-100 dark:bg-slate-900 rounded-xl">
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${activeSection === 'slides'
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${activeSection === 'settings'
                        ? 'bg-white dark:bg-slate-700 text-gray-900 dark:text-white shadow-sm'
                        : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'
                        }`}
                >
                                    ...
                                    <div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <SlideImageUploader
                                                ...
                                                onImageChange={(file) => handleImageChange(slide.id, file, 'imageDesktopAr')}
                                                onImageDelete={() => onUpdateSlideImage(slide.id, 'imageDesktopAr', '')}
                                            />
                                            <SlideImageUploader
                                                ...
                                                onImageChange={(file) => handleImageChange(slide.id, file, 'imageDesktopEn')}
                                                onImageDelete={() => onUpdateSlideImage(slide.id, 'imageDesktopEn', '')}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="max-w-sm">
                                            <SlideImageUploader
                                                ...
                                                onImageChange={(file) => handleImageChange(slide.id, file, 'imageMobile')}
                                                onImageDelete={() => onUpdateSlideImage(slide.id, 'imageMobile', '')}
                                            />
                                        </div>
                                    </div>
                                </div>
