...
// PAGE COMPONENT
// ═══════════════════════════════════════════════════════════
export default function ServicesPageClient({ initialServices, initialFleet, initialPorts, initialCargo }: { initialServices: Service[]; initialFleet: any[]; initialPorts: any[]; initialCargo: any[] }) {
    ...
    // Dynamic section state — all provided via props from server component
    const [fleetTrucks] = useState<any[]>(initialFleet);
    const [ports] = useState<any[]>(initialPorts);
    const [specializedCargo] = useState<any[]>(initialCargo);

    // Services data is now provided via initialServices prop from server component
                                    ...
                                    >
                                        <Link href={`/services/${service.slug}`} className="block h-full">
                                            ...
                                            >
                                                {/* Hover glow */}
                                                <motion.div
                                                    className="absolute inset-0 rounded-3xl bg-gradient-to-br from-brand-orange/5 to-transparent pointer-events-none"
                                                    initial={{ opacity: 0 }}
                                                ...
                                                {service.image ? (
                                                    <motion.div
                                                        className="relative w-full h-36 md:h-52 overflow-hidden"
                                                    ...
                                                    >
                                                        ...
                                                        <div className="absolute bottom-3 right-3 md:bottom-4 md:right-4 w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-lg pointer-events-none">
                                                            <Icon className="w-5 h-5 md:w-6 md:h-6 text-brand-orange" />
                                                        </div>
                                                    </motion.div>
                                                ) : (
                                                    <div className="p-5 pb-0 md:p-8 md:pb-0">
                                                        <motion.div
                                                            className="relative w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center text-white shadow-2xl bg-brand-orange"
                                                            whileHover={{ scale: 1.1, rotate: 5 }}
                                                        >
                                                            <div className="absolute inset-0 rounded-2xl blur-xl opacity-50 bg-brand-orange pointer-events-none" />
                                                ...
                                                <div className="p-5 md:p-8 flex flex-col flex-grow">
                                                    {/* Title */}
                                                    <h3 className="text-lg md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white mb-2 md:mb-4 relative group-hover:text-brand-orange transition-colors">
                                                        {isRTL ? service.titleAr : service.titleEn}
                                                    </h3>

                                                    {/* Description — 2-line clamp on mobile */}
                                                    <p className="text-gray-600 dark:text-gray-400 mb-4 md:mb-6 flex-grow leading-relaxed relative font-normal text-sm md:text-base line-clamp-2 md:line-clamp-none">
                                                        {isRTL ? service.shortDescAr : service.shortDescEn}
                                                    </p>

                                                    {/* Features — hidden on mobile for compact cards */}
                                                    <div className="hidden md:block space-y-3 mb-6 relative">
                                                    ...
                                                    {/* CTA */}
                                                    <motion.div
                                                        className="flex items-center gap-2 font-semibold text-sm md:text-lg relative text-brand-orange mt-auto"
            ...
            <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 dark:text-white mb-4">
                            {isRTL ? 'نقل البضائع الخاصة والحمولات الثقيلة' : 'Specialized Cargo & Heavy Transport Solutions'}
                        </h2>
                        <p className="text-gray-600 dark:text-gray-400 text-base md:text-lg max-w-2xl mx-auto font-normal">
                            {isRTL
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {specializedCargo.map((cargo: any, idx: number) => {
                            ...
                            const cargoBackgrounds: Record<string, string> = {
                                'Marble, Quarry & Mining Transport': '/images/cargo/marble-quarry.jpg',
                            ...
                            const cardContent = (
                                ...
                                >
                                    ...
                                    {cargoBg && (
                                        <div className="absolute inset-0 pointer-events-none">
                                            <img src={cargoBg} alt="" className="w-full h-full object-cover" loading="lazy" />
                                            <div className="absolute inset-0 bg-black/50 md:bg-black/40 group-hover:bg-black/45 md:group-hover:bg-black/35 transition-colors duration-500" />
                                        </div>
                                    )}
                                    ...
                                    {cargoLink && (
                                        <div className="flex items-center gap-2 mt-4 pt-4 md:mt-6 md:pt-5 border-t border-white/20
                                                        text-brand-orange font-semibold text-sm
                                                        group-hover:gap-3 transition-all duration-300 relative">
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 dark:text-white mb-4">
                            {isRTL ? 'أسطول النقل الخاص بنا لنقل الحاويات' : 'Our Fleet for Container Transport'}
                        </h2>
                        <p className="text-gray-600 dark:text-gray-400 text-base md:text-lg max-w-2xl mx-auto font-normal">
                            {isRTL
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        {fleetTrucks.filter((t: any) => t.image).map((truck: any, idx: number) => {
                            let specs: any[] = [];
            ...
            <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-marine-900 dark:via-marine-800 dark:to-slate-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 dark:text-white mb-4">
                            {isRTL ? 'عمليات الموانئ وخدمات الشحن' : 'Port Operations & Shipping Services'}
                        </h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {ports.filter((p: any) => p.image).map((port: any, idx: number) => {
                            let factsAr: string[] = [];
                            let factsEn: string[] = [];
                            try {
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden shadow-xl group">
                                <Image
                                    ...
                                    alt="Port operations — SAMA Logistics, Port Said"
                                    width={400}
                                    height={250}
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-xl group">
                                <Image
                                    ...
                                    alt="Fleet transport trucks — SAMA Logistics"
                                    width={400}
                                    height={250}
                                    className="w-full h-[250px] object-cover group-hover:scale-105 transition-transform duration-700"
                                    loading="lazy"
                            ...
                            <div className="grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-4 mb-6 md:mb-8">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        className="group relative text-center p-2.5 md:p-6 bg-white dark:bg-slate-800/70 backdrop-blur-sm rounded-xl md:rounded-2xl border border-gray-100 dark:border-white/10 shadow-[0_2px_16px_-2px_rgba(0,0,0,0.08)] md:shadow-lg hover:shadow-2xl hover:-translate-y-1 active:scale-[0.98] active:-translate-y-0.5 transition-all duration-300"
                                    >
                            ...
                            >
                                {[
                                    ...
                                    <div key={idx} className="text-center">
                                        <div className="text-2xl md:text-2xl font-extrabold md:font-bold text-brand-orange">
                                            {isRTL ? stat.valueAr : stat.valueEn}
                                        </div>
                                        <div className="text-[10px] md:text-[11px] text-gray-400 dark:text-gray-500 font-medium">
